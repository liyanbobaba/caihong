...
function getPoint(){
    ...
    if(inputname=='hide'){
        ...
        $('#inputsname').append('<div class="fui-cell"><div  class="fui-cell-label" style="padding-right: 15px;" id="inputname">' + inputname + '</div><div class="fui-cell-info"><input type="text" name="inputvalue" id="inputvalue" value="'+($_GET['qq']?$_GET['qq']:'')+'" placeholder="请输入QQ账号" class="fui-input" required onblur="checkInput()"/></div></div>');
        ...
        if(inputsname!=''){
            $.each(inputsname.split('|'), function(i, value) {
                ...
                if(value.indexOf('{')>0 && value.indexOf('}')>0){
                    ...
                    $('#inputsname').append('<div class="fui-cell"><div class="fui-cell-label" style="padding-right: 15px;" id="inputname'+(i+2)+'">' + selectname + '</div><div class="fui-cell-info"><input type="text" class="fui-input" name="inputvalue'+(i+2)+'" id="inputvalue'+(i+2)+'" value="" onBlur="window.scrollTo(0, 0);"></div></div>');
                }else{
                    if(value=='说说ID'||value=='说说ＩＤ'||inputsnametype=='ssid')
                        var addstr='<button class="layui-btn layui-btn-normal" onclick="get_shuoshuo(\'inputvalue'+(i+2)+'\',$(\'#inputvalue\').val())")>自动获取</button>';
                    else if(value=='日志ID'||value=='日志ＩＤ'||inputsnametype=='rzid')
                        var addstr='<button class="layui-btn layui-btn-normal" onclick="get_rizhi(\'inputvalue'+(i+2)+'\',$(\'#inputvalue\').val())">自动获取</button>';
                    else if(value=='作品ID'||value=='作品ＩＤ'||inputsnametype=='zpid')
                        var addstr='<button class="layui-btn layui-btn-normal" onclick="get_shareid2(\'inputvalue'+(i+2)+'\',$(\'#inputvalue\').val())">自动获取</button>';
                    else if(value=='收货地址'||value=='收货人地址'||inputsnametype=='address')
                        var addstr='<button class="layui-btn layui-btn-normal" onclick="getCity(\'inputvalue'+(i+2)+'\',$(\'#inputvalue\').val())">自动获取</button>';
                    else
                        var addstr='';
                    if(addstr!=''){
                        $('#inputsname').append('<div class="fui-cell"><div class="fui-cell-label" style="padding-right: 15px;" id="inputname'+(i+2)+'" gettype="'+inputsnametype+'">' + value + '</div><div class="fui-cell-info"><input type="text" class="fui-input" name="inputvalue'+(i+2)+'" id="inputvalue'+(i+2)+'" value="" onBlur="window.scrollTo(0, 0);">' + addstr + '</div></div>');
                    }else{
                        $('#inputsname').append('<div class="fui-cell"><div class="fui-cell-label" style="padding-right: 15px;" id="inputname'+(i+2)+'" gettype="'+inputsnametype+'">' + value + '</div><div class="fui-cell-info"><input type="text" class="fui-input" name="inputvalue'+(i+2)+'" id="inputvalue'+(i+2)+'" value="" onBlur="window.scrollTo(0, 0);">' + addstr + '</div></div>');
                    }
                }
        ...
        success : function(data) {
            ...
            if(data.code == 0){
                ...
                if($('#show_shuoshuo').length > 0){
                    ...
                    $('#show_shuoshuo').html('<div class="fui-cell"><div class="fui-cell-info"><button type="button" class="layui-btn" onclick="get_shuoshuo(\''+id+'\',$(\'#inputvalue\').val(),'+km+','+lastpage+')">上一页</button><select id="shuoid" lay-verify="" onchange="set_shuoshuo(\''+id+'\');">' + addstr + '</select><button type="button" class="layui-btn" onclick="get_shuoshuo(\''+id+'\',$(\'#inputvalue\').val(),'+km+','+nextpage+')">下一页</button></div></div>');
                }else{
                    // $('#inputsname').append('<div class="form-group" id="show_shuoshuo"><div class="input-group"><div class="input-group-addon onclick" title="上一页" onclick="get_shuoshuo(\''+id+'\',$(\'#inputvalue\').val(),'+km+','+lastpage+')">上一页</div><select id="shuoid" class="form-control" onchange="set_shuoshuo(\''+id+'\');">'+addstr+'</select><div class="input-group-addon onclick" title="下一页" onclick="get_shuoshuo(\''+id+'\',$(\'#inputvalue\').val(),'+km+','+nextpage+')">下一页</div></div></div>');
                    $('#inputsname').append('<div class="fui-cell layui-form layui-form-pane" id="show_shuoshuo"><div class="fui-cell-info"><button type="button" class="layui-btn" onclick="get_shuoshuo(\''+id+'\',$(\'#inputvalue\').val(),'+km+','+lastpage+')">上一页</button><select id="shuoid" lay-verify="" onchange="set_shuoshuo(\''+id+'\');">' + addstr + '</select><button type="button" class="layui-btn" onclick="get_shuoshuo(\''+id+'\',$(\'#inputvalue\').val(),'+km+','+nextpage+')">下一页</button></div></div>');
                }
        ...
        success : function(data) {
            ...
            if(data.code == 0){
                ...
                if($('#show_rizhi').length > 0){
                    ...
                    $('#show_rizhi').html('<div class="fui-cell"><div class="fui-cell-info"><button type="button" class="layui-btn" onclick="get_rizhi(\''+id+'\',$(\'#inputvalue\').val(),'+km+','+lastpage+')">上一页</button><select id="shuoid" lay-verify="" onchange="set_shuoshuo(\''+id+'\');">' + addstr + '</select><button type="button" class="layui-btn" onclick="get_rizhi(\''+id+'\',$(\'#inputvalue\').val(),'+km+','+nextpage+')">下一页</button></div></div>');
                }else{
...
function getCity(inputid,fid,i){
    ...
    fid = fid || 0;
    if(i == 0){
        var options='<select class="form-control" lay-filter="" id="biaozhi_'+(i+1)+'" onchange="getCity(\''+inputid+'\',this.value,'+(i+1)+')">';
